    ...
    class Program
    {
        ...
        */
        static string AfficherMatch(string choix, Data data, int c, int s, Match match, List<List<double>> cotes)
        {
            ...
            if ((V1MT > 57) && (cotes[1][0] * V1MT > 92)) Console.WriteLine("Vainqueur mi-temps : " + e1.Nom + " (" + cotes[1][0] + ")");
            else if ((100 - V1MT - V2MT > 56) && (cotes[1][1] * (100 - V1MT - V2MT) > 92)) Console.WriteLine("Vainqueur mi-temps : NUL (" + cotes[1][1] + ")");
            else if ((V2MT > 57) && (cotes[1][2] * V2MT > 92)) Console.WriteLine("Vainqueur mi-temps : " + e2.Nom + " (" + cotes[1][2] + ")");
            if ((V1FT > 57) && (cotes[0][0] * V1FT > 92)) Console.WriteLine("Vainqueur final : " + e1.Nom + " (" + cotes[0][0] + ")");
            else if ((100 - V1FT - V2FT > 57) && (cotes[0][1] * (100 - V1FT - V2FT) > 92)) Console.WriteLine("Vainqueur final : NUL (" + cotes[0][1] + ")");
            else if ((V2FT > 57) && (cotes[0][2] * V2FT > 92)) Console.WriteLine("Vainqueur final : " + e2.Nom + " (" + cotes[0][2] + ")");
            if ((BTTSFT > 57) && (cotes[2][0] * BTTSFT > 92)) Console.WriteLine("BTTS Oui : " + "(" + cotes[2][0] + ")");
            else if ((100 - BTTSFT > 57) && (cotes[2][1] * (100 - BTTSFT) > 92)) Console.WriteLine("BTTS Non : " + "(" + cotes[2][1] + ")");
            if ((FTplus1 > 57) && (cotes[3][0] * FTplus1 > 95)) Console.WriteLine("Plus de 0.5 buts dans le match : " + "(" + cotes[3][0] + ")");
            else if ((FTplus2 > 57) && (cotes[3][1] * FTplus2 > 95)) Console.WriteLine("Plus de 1.5 buts dans le match : " + "(" + cotes[3][1] + ")");
            else if ((FTplus3 > 57) && (cotes[3][2] * FTplus3 > 95)) Console.WriteLine("Plus de 2.5 buts dans le match : " + "(" + cotes[3][2] + ")");
            else if ((FTplus4 > 57) && (cotes[3][3] * FTplus4 > 95)) Console.WriteLine("Plus de 3.5 buts dans le match : " + "(" + cotes[3][3] + ")");
            if ((100 - FTplus1 > 57) && (cotes[4][0] * (100 - FTplus1) > 95)) Console.WriteLine("Moins de 0.5 buts dans le match : " + "(" + cotes[4][0] + ")");
